/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/env.d.ts` (hash: 84674ac28a75b131a3740c5d8ca389f8)
// Runtime types generated with workerd@1.20260915.1 2026-09-17 nodejs_compat
// NOTE: EMAIL_MODE below was added by hand (not by `wrangler types`) after wrangler.jsonc's vars
// gained EMAIL_MODE, because regenerating in this sandboxed/offline environment dropped the
// WHATSAPP_WEBHOOK_URL/WHATSAPP_WEBHOOK_TOKEN/NOTIFICATIONS_CRON_TOKEN optional secrets that a
// prior `wrangler types` run (with different local/network context) had included — rather than
// risk losing those real bindings, this file keeps their previous shape and only adds the new
// var by hand. Re-run `pnpm worker:types` in a normal dev environment to get a fully
// wrangler-regenerated file (and to confirm this hand edit matches what it would produce) before
// the next deploy.
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "EMAIL_FROM" | "PAYMENTS_MODE" | "EMAIL_MODE" | "TOKEN_PEPPER" | "RATE_LIMIT_SECRET" | "RESEND_API_KEY" | "MASTER_BOOTSTRAP_TOKEN">> {}
}
